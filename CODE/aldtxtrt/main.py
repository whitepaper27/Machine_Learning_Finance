...
class Reddit:
    ...
    def get_SubbReddit_data(self,reddit,sub,max_limit):
        ...
        #Only for daily data
        #subreddit = reddit.subreddit(sub).top('month', limit=max_limit)
        #subreddit = reddit.subreddit(sub).top('year', limit=max_limit)
        subreddit = reddit.subreddit(sub).top('week', limit=max_limit)
        my_list=[]
        #
        for submission in subreddit:
            ...
            #this is for daily data collection
...
if __name__ == '__main__':
    ...
    for sub in sublist:
        ...
        #Get Detail Reddit Data comment it if you do not want comment data
